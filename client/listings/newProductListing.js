Template.newProductListing.rendered = function(){
	$( "#spinner-01" ).spinner();
	Holder.run();
	$('.fileinput').fileinput();
...
Template.newProductListing.helpers({
	categories: function(){
		return productCategories;
	}
});
Template.newProductListing.events({
	"submit #newListing": function(e, t){
		...
		var context = productListingSchema.namedContext("listingForm");
